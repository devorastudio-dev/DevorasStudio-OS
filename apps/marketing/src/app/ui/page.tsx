      ...
      <div className="mx-auto flex min-w-0 max-w-5xl flex-col gap-8">
        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-2">
          <Card className="min-w-0 space-y-5">
            ...
            <div>
              <Label htmlFor="marketing-name">Nome</Label>
              <Input id="marketing-name" placeholder="Nome da pessoa" />
            </div>
            <div>
              <Label htmlFor="marketing-email">E-mail inválido</Label>
              <Input
                aria-describedby="marketing-email-error"
                aria-invalid="true"
                id="marketing-email"
                type="email"
                ...
                readOnly
              />
              <p className="mt-2 text-sm text-error" id="marketing-email-error">
                Informe um endereço de e-mail válido.
              </p>
            </div>
            <div>
              <Label htmlFor="marketing-message">Mensagem</Label>
              <Textarea
